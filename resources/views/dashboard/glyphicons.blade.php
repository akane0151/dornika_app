        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Glyphicons
                            <small>عناصر طراحی آیکون های مختلف</small>
                        </h2>
                    ...
                    <div class="x_content">
                        ...
                        <div class="bs-docs-section">
                            ...
                            <h2 id="glyphicons-glyphs">گلیف‌های موجود</h2>
                            <p>شامل 260 علامت در قالب فونت از مجموعه Glyphicon Halflings است. <a
                                    href="https://glyphicons.com/">Glyphicons Halflings </a>معمولا به صورت رایگان در
                                دسترس نیستند، اما خالق آنها برای Bootstrap به صورت رایگان در دسترس قرار داده است.
                                به عنوان تشکر، از شما می‌خواهیم یک پیونده به سایت<a
                                        href="https://glyphicons.com/">Glyphicons</a> بدهید هر زمان که امکانش را داشتید.
                            </p>
                            ...
                            <h2 id="glyphicons-how-to-use">چگونگی استفاده</h2>
                            <p>به دلایل عملکرد، تمام آیکون ها نیاز به یک کلاس پایه و یک کلاس آیکون خاص دارند. که استفاده
                                کنید، کد زیر را فقط در هر نقطه قرار دهید. اطمینان حاصل کنید که فاصله بین آیکون و متن
                                برای پوشش مناسب را ایجاد کنید.</p>
                            <div class="bs-callout bs-callout-danger" id="callout-glyphicons-dont-mix">
                                <h4>با اجزای دیگر مخلوط نکنید</h4>
                                <p>کلاس های نماد نمی تواند به طور مستقیم با اجزای دیگر ترکیب شود. آنها نباید همراه با
                                    کلاس های دیگر در همان عنصر استفاده شوند. در عوض، <code>&lt;span&gt;</code>
                                    درونی دیگری اضافه کنید و کلاس نماد را به <code>&lt;span&gt;</code> بدهید.</p>
                            </div>
                            <div class="bs-callout bs-callout-danger" id="callout-glyphicons-empty-only">
                                <h4>فقط برای استفاده در عناصر خالی</h4>
                                <p>کلاس آیکون ها فقط باید در عناصر حاوی محتوای متن و هیچ یک از عناصر دارای زیر مجموعه
                                    استفاده شود.</p>
                            </div>
                            <div class="bs-callout bs-callout-info" id="callout-glyphicons-location">
                                <h4>تغییر محل فونت آیکون</h4>
                                <p>فوت آیکون های Bootstrap در محل <code dir="ltr">../fonts/</code>
                                    وجود دارد, که محل فونت ها در زمان کامپایل css ها می‌باشد. جابجایی و یا تغییر نام
                                    هریک از این فونت ها باید CSS را به یکی از سه شکل زیر تغییر دهید:</p>
                                <ul>
                                    <li>تغییر مقدار<code dir="ltr">@icon-font-path</code> و/یا <code dir="ltr">@icon-font-name</code>
                                        متغیر در فایل منبع LESS.
                                    </li>
                                    <li>استفاده از <a
                                            href="http://lesscss.org/usage/#command-line-usage-relative-urls">گزینه URL
                                        نسبی</a> که با استفاده از Less کامپایلر در دسترس است.
                                    </li>
                                    <li>تغییر آدرس <code dir="ltr">url()</code> در فایل CSS کامپایل شده.</li>
                                </ul>
                                <p>از بهترین گزینه که برای محیط کاری شما مناسب است استفاده نمایید.</p>
                            </div>
                            <div class="bs-callout bs-callout-warning" id="callout-glyphicons-accessibility">
                                <h4>آیکون‌ها دسترس پذیری</h4>
                                <p>نسخه های مدرن از فناوری های کمک کننده محتوای CSS تولید شده و همچنین کاراکترهای
                                    Unicode خاص را اعلام خواهند کرد. برای جلوگیری از خروج ناخواسته و گیج کننده در
                                    خوانندگان روی صفحه (به خصوص وقتی که آیکون ها صرفا برای دکوراسیون استفاده می شوند)،
                                    ما آنها را با ویژگی <code dir="ltr">aria-hidden = "true"</code>پنهان میکنیم.</p>
                                <p>اگر از آیکون برای انتقال معنای (به جای فقط به عنوان یک عنصر تزئینی) استفاده کنید،
                                    اطمینان حاصل کنید که این معنا نیز به فن آوری های کمک رسانی منتقل می شود - مثلا شامل
                                    محتوای اضافی است که بصری با کلاس <code dir="ltr">.sr-only</code> پنهان شده است.
                                </p>
                                <p>
                                    اگر شما کنترل هایی را با هیچ متن دیگر (مانند <code>&lt;button&gt;</code> که شامل یک
                                    آیکون است) ایجاد می کنید، همیشه باید مواد جایگزین را برای شناسایی هدف کنترل، به طوری
                                    که آن را برای کاربران فناوری های کمک کننده معنا داشته باشد. در این مورد، شما می
                                    توانید ویژگی های <code>aria-label</code>را بر روی کنترل خود اضافه کنید.</p>
                            </div>
                            <div class="zero-clipboard"><span class="btn-clipboard">کپی</span>
                            </div>
                            <div class="highlight">
                            ...
                            <h2 id="glyphicons-examples">مثال‌ها</h2>
                            <p>از آنها در دکمه ها، گروه های دکمه برای نوار ابزار، ناوبری یا ورودی های فرم استفاده شده
                                استفاده کنید.</p>
                            <div class="bs-example" data-example-id="glyphicons-general">
                                ...
                                <div class="btn-toolbar" role="toolbar">
                                    <button type="button" class="btn btn-default btn-lg"><span
                                            class="glyphicon glyphicon-star" aria-hidden="true"></span> ستاره
                                    </button>
                                    <button type="button" class="btn btn-default"><span class="glyphicon glyphicon-star"
                                                                                        aria-hidden="true"></span> ستاره
                                    </button>
...
<span class="nt">&lt;button</span> <span class="na">type=</span><span class="s">"button"</span> <span
  ...
  <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"glyphicon glyphicon-star"</span> <span
            class="na">aria-hidden=</span><span class="s">"true"</span><span class="nt">&gt;&lt;/span&gt;</span> ستاره
<span class="nt">&lt;/button&gt;</span></code></pre>
                            </div>

                            <p>
                                یک آیکون در هشدار استفاده می شود که نشان می دهد این یک پیام <a href="#alerts">خطا</a>
                                است؛ با افزودن <code dir="ltr">.sr-only</code> متن برای انتقال این اشاره به کاربران فن
                                آوری های کمک.</p>
                            <div class="bs-example" data-example-id="glyphicons-accessibility">
                                <div class="alert alert-danger" role="alert">
                                    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                                    <span class="sr-only">اخطار:</span> یک ایمیل آدرس صحیح وارد نمایید.
                                </div>
                            </div>
                            <div class="zero-clipboard"><span class="btn-clipboard">کپی</span>
                            </div>
...
<pre><code class="language-html" data-lang="html"><span class="nt">&lt;div</span> <span class="na">class=</span><span
  ...
  <span class="nt">&lt;span</span> <span class="na">class=</span><span class="s">"sr-only"</span><span
            class="nt">&gt;</span>خطا:<span class="nt">&lt;/span&gt;</span>
  یک ایمیل آدرس صحیح وارد نمایید.
