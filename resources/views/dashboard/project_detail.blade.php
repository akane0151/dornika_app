                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            ...
                            <div>
                                ...
                                <ul class="messages">
                                    <li>
                                        <img src="{{asset('build/images/img.jpg')}}" class="avatar" alt="Avatar">
                                        ...
                                        <div class="message_wrapper">
                                            ...
                                            <blockquote class="message">کتابهای زیادی در شصت و سه درصد گذشته، حال و
                                                آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت
                                                بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در
                                                زبان فارسی ایجاد کرد. لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از
                                    ...
                                    <li>
                                        ...
                                        <div class="message_wrapper">
                                            ...
                                            <blockquote class="message">در این صورت می توان امید داشت که تمام و دشواری
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <h3 class="green"><i class="fa fa-paint-brush"></i> قالب مدیریت</h3>
                                    ...
                                    <div class="text-center mtop20">
                                        <a href="#" class="btn btn-sm btn-primary">افزودن فایل‌ها</a>
                                        <a href="#" class="btn btn-sm btn-warning">گزارش تماس</a>
                                    </div>
                                </div>
