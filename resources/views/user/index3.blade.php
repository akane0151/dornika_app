                        ...
                        <div class="col-xs-12 bg-white progress_summary">
                            ...
                            <div class="row">
                                <div class="progress_title">
                                    <span class="right">دستگاه وایرلس 1.0</span>
                                    <span class="left">این سیس</span>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="progress_title">
                                    <span class="right">دسترسی موبایل</span>
                                    <span class="left">تلفن هوشمند</span>
                                    <div class="clearfix"></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="progress_title">
                                    <span class="right">کاربران دسترسی اینترت</span>
                                    <span class="left">تعداد 69%</span>
                                    <div class="clearfix"></div>
                                </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="x_panel fixed_height_320">
                    ...
                    <div class="x_content">
                        <div class="dashboard-widget-content">
                            <ul class="quick-list">
                                <li><i class="fa fa-bars"></i><a href="#">اشتراک</a></li>
                                <li><i class="fa fa-bar-chart"></i><a href="#">خودکار تمدید</a></li>
                                <li><i class="fa fa-support"></i><a href="#">میز کمک</a></li>
                                <li><i class="fa fa-heart"></i><a href="#">کمک های مالی</a></li>
                            </ul>
