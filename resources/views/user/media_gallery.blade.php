    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3> گالری چند رسانه‌ای
                    <small> طراحی گالری</small>
                </h3>
            </div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="row">
                            ...
                            <p>عناصر طراحی گالری رسانه</p>

                            <div class="col-md-55">
                                <div class="thumbnail">
                                    <div class="image view view-first">
                                        <img style="width: 100%; display: block;" src="{{asset('build/images/media.jpg')}}" alt="image"/>
                                        <div class="mask">
                                            <p>متن شما</p>
