        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>تایپوگرافی
                            <small>عناصر طراحی متفاوت</small>
                        </h2>
                    ...
                    <div class="x_content">
                        ...
                        <div class="col-md-8 col-lg-8 col-sm-7">
                            ...
                            <blockquote>
                                ...
                                <footer>کسی معروف در <cite title="Source Title">عنوان منبع</cite>
                                </footer>
                            </blockquote>
                        ...
                        <div class="col-md-12">
                            <h4>برچسب ها و مدالها</h4>
                            <span class="label label-default">پیشفرض</span>
                            <span class="label label-primary">اولیه</span>
                            <span class="label label-success">موفق</span>
                            <span class="label label-info">اطلاع</span>
                            <span class="label label-warning">اخطار</span>
                            <span class="label label-danger">خطر</span>
