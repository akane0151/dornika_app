...
<div class="right_col" role="main">
    <div class="">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">نام
                                    میانی </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">دکمه اضافه</label>

                                <div class="col-sm-9">
                                    <div class="input-group">
                            <span class="input-group-btn">
                                              <button type="button" class="btn btn-primary">برو!</button>
                                          </span>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <button type="button" class="btn btn-default dropdown-toggle"
                                                    data-toggle="dropdown" aria-expanded="false">عمل <span
                                                    class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                <li><a href="#">عمل</a>
                                                </li>
                                                <li><a href="#">عملی دیگر</a>
                                                </li>
                                                <li><a href="#">چیزی دیگر در اینجا</a>
                                                </li>
                                                <li class="divider"></li>
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>گرید های فرم ورودی
                    <small>ورودی فرم</small>
                </h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
