                        ...
                        <div class="row">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div style="text-align: center; margin-bottom: 15px;">
                                            <div class="btn-group" role="group" aria-label="First group">
                                                <button type="button" class="btn btn-default btn-sm">روز</button>
                                                <button type="button" class="btn btn-default btn-sm">ماه</button>
                                                <button type="button" class="btn btn-default btn-sm">سال</button>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <ul class="list-inline widget_tally">
                                                <li>
                                                    <p>
                                                        <span class="month">12 خرداد 1396 </span>
                                                        <span class="count">+12%</span>
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>
                                                        <span class="month">10 خرداد 1396 </span>
                                                        <span class="count">+12%</span>
                                                    </p>
                                                </li>
                                                <li>
                                                    <p>
                                                        <span class="month">16 اردیبهشت 1396 </span>
                                                        <span class="count">+12%</span>
                                                    </p>
                                                </li>
                                            </ul>
                                ...
                                <div class="x_panel fixed_height_390">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <ul class="legend list-unstyled">
                                            <li>
                                                <p>
                                                    <span class="icon"><i class="fa fa-square dark"></i></span> <span
                                                        class="name">نام آیتم اول</span>
                                                </p>
                                            </li>
                                            <li>
                                                <p>
                                                    <span class="icon"><i class="fa fa-square grey"></i></span> <span
                                                        class="name">نام آیتم دوم</span>
                                                </p>
                                            </li>
                                            <li>
                                                <p>
                                                    <span class="icon"><i class="fa fa-square blue"></i></span> <span
                                                        class="name">نام آیتم سوم</span>
                                                </p>
                                            </li>
                                            <li>
                                                <p>
                                                    <span class="icon"><i class="fa fa-square green"></i></span> <span
                                                        class="name">نام آیتم چهارم</span>
                                                </p>
                                            </li>
                                        </ul>
                            ...
                            <div class="col-md-3 col-xs-12 widget widget_tally_box">
                              ...
                              <span class="chart" data-percent="86">
                                        ...
                                        <h3 class="name_title">مالی</h3>
                                        <p>توضیح کوتاه</p>

                                        <div class="divider"></div>

                                        <p>اگر تصمیم گرفتید که در حالت توسعه قرار گیرید و همه اینها را نیشگون بگیرید، چیزهایی که باید انجام دهید کمی است.</p>
