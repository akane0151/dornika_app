                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                                <div class="well profile_view">
                                    <div class="col-sm-12">
                                        <h4 class="brief"><i>استراتژیست دیجیتال</i></h4>
                                        <div class="left col-xs-7">
                                            <h2>مرتضی کریمی</h2>
                                            <p><strong>درباره: </strong> طراح وب / UX / گرافیست بازیگر / قهوه دوست </p>
                                            <ul class="list-unstyled">
                                                <li><i class="fa fa-building"></i> آدرسی:</li>
                                                <li><i class="fa fa-phone"></i> تلفن #:</li>
                                            </ul>
                                        </div>
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12 profile_details">
                                <div class="well profile_view">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="left col-xs-7">
                                            <h2>مرتضی کریمی</h2>
                                            <p><strong>درباره: </strong> طراح وب و UI. </p>
                                            <ul class="list-unstyled">
                                                <li><i class="fa fa-building"></i> آدرسی:</li>
                                                <li><i class="fa fa-phone"></i> تلفن #:</li>
                                            </ul>
                                        ...
                                        <div class="right col-xs-5 text-center">
                                            <img src="{{asset('build/images/user.png')}}" alt=""
