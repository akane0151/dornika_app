                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                        ...
                        @foreach($cities as $c)
                            <tr>
                                ...
                                <td>{{$c->state->name}}</td>
                                <td>
                                    <button id="editItem" data-button="{{$c->id}}" class="btn btn-warning btn-xs">ویرایش</button>
                                    <button id="removeItem" data-button="{{$c->id}}" data-name="{{$c->name}}" class="btn btn-danger btn-xs">حذف</button>
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">اضافه کردن</h4>
                </div>
                <div class="modal-body">
                    <form id="demo-form">
                        <label for="state">نام شهر<span class="required">*</span> :</label>
                        <input type="text" id="name" class="form-control" name="name" required/>
                        <label for="state">استان<span class="required">*</span> :</label>
                        <select id="stateId">
                            @foreach($states as $s)
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2">ویرایش</h4>
                </div>
                <div class="modal-body">
                    <form id="demo-form">
                        <label for="state">نام شهر<span class="required">*</span> :</label>
...
<script>
    $(document).ready(function () {
        ...
        $(".add-modal-sm").on("click",".add-btn", function(event) {
            ...
            var stateId = $(".add-modal-sm #stateId").val();
            $("#modal-error").hide();
            $("#modal-success").hide();
            $("#modal-loading").show();
            $.ajax({
        ...
        $(".edit-modal-sm").on("click",".edit-btn", function(event) {
            ...
            var stateId = $(".edit-modal-sm #stateId").val();
